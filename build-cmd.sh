...
pushd "$OPENSSL_SOURCE_DIR"
    case "$AUTOBUILD_PLATFORM" in
        ...
        windows*)
            ...
            mv libssl-3$sfx.dll $stage/lib/release/.
            mv libssl-3$sfx.pdb $stage/lib/release/.
            mv libssl_static.lib $stage/lib/release/.
            mv libssl.lib $stage/lib/release/.
            mv libcrypto-3$sfx.dll $stage/lib/release/.
            mv libcrypto-3$sfx.pdb $stage/lib/release/.
